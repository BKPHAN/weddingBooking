...
public class AdminDashboardService {
    ...
    public DashboardResponse getOverview() {
        ...
        response.setRecentContacts(contactMapper.toResponseList(contactRepository.findTop10ByOrderByCreatedAtDesc()));
        response.setUpcomingBookings(
                bookingRepository.findTop5ByEventDateGreaterThanEqualOrderByEventDateAsc(LocalDate.now())
                        .stream()
